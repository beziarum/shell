...
côtés du pipe dans le père, pour celà nous avons rajouté un champs dans la structure contexte.
...
On affiche ensuite ce dernier.
 ...
 un processus fils si elles devaient l'être en arrière plan.
 ...
 avec la fonction traitant cette commande.
